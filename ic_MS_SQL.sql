...
create table S15827_PACKAGE_TYPE (
	...
	DESCRIPTION VARCHAR(200) null, constraint PACKAGE_TYPE_PK primary key (SHORT_NAME) ); 
...
create table S15827_REL_IC_SKLEP (
	...
	"NUMBER" tinyint null,
	CENA smallmoney null, constraint REL_IC_SKLEP_PK primary key (CIRCUIT_NAME, SKLEP) ); 
...
create table S15827_ISA (
	...
	ISA_NAME VARCHAR(30) not null,
	BIT_REGISTER tinyint null, constraint ISA_PK primary key (ISA_NAME) ); 
...
create table S15827_SKLEP (
	...
	CURRENCY VARCHAR(4) null, constraint SKLEP_PK primary key (ID) ); 
...
create table S15827_IN_OUT (
	...
	DESCRIPTION VARCHAR(200) null, constraint IN_OUT_PK primary key (IO_NAME) ); 
...
create table S15827_REGISTER_TYPE (
	...
	DESCRIPTION VARCHAR(200) null, constraint REGISTER_TYPE_PK primary key (TYPE_NAME) ); 
...
create table S15827_INTEGRATED_CIRCUIT (
	...
	DATASHEET VARCHAR(150) null,
	PACKAGE_FORMAT VARCHAR(4) null, constraint INTEGRATED_CIRCUIT_PK primary key (NAME) ); 
...
create table S15827_FLASH_MEMORY (
	NAME VARCHAR(30) not null,
	MEMORY_SIZE VARCHAR(30) null,
	GPIO tinyint null,
	BITS_PER_WORD tinyint null, constraint FLASH_MEMORY_PK primary key (NAME) ); 
...
create table S15827_LOGIC_FAMILY (
	...
	TOGGLE_SPEED VARCHAR(30) null,
	SUPPLY_VOLTAGE VARCHAR(30) null, constraint LOGIC_FAMILY_PK primary key (ID) ); 
...
create table S15827_LOGIC_TYPE (
	TYPE_NAME VARCHAR(4) not null,
	DISTINCTIVE_SHAPE VARCHAR(150) null,
	TRUTH_TABLE VARCHAR(50) null, constraint LOGIC_TYPE_PK primary key (TYPE_NAME) ); 
...
create table S15827_SHIFT_REGISTER (
	NAME VARCHAR(30) not null,
	BIT_REGISTER tinyint null,
	GPIO tinyint null,
	IO VARCHAR(8) null,
	TYPE VARCHAR(4) null, constraint SHIFT_REGISTER_PK primary key (NAME) ); 
...
create table S15827_SWITCH_TYPE (
	TYPE_NAME VARCHAR(4) not null,
	DESCRIPTION VARCHAR(200) null, constraint SWITCH_TYPE_PK primary key (TYPE_NAME) ); 
...
create table S15827_MUX_DEMUX (
	NAME VARCHAR(30) not null,
	GPIO tinyint null,
	SWITCH_TYPE VARCHAR(4) null, constraint MUX_DEMUX_PK primary key (NAME) ); 
...
create table S15827_MICROCONTROLLER (
	...
	PROCESSOR_CORE VARCHAR(30) null,
	FLASH_MEMORY VARCHAR(30) null,
	GPIO tinyint null,
	TIMER bit null,
	PWM_GENERATOR bit null,
	WATCHDOG bit null,
	INTERRUPTS tinyint null,
	UART bit null,
	I2C bit null,
	SPI bit null,
	AWIRE bit null, constraint MICROCONTROLLER_PK primary key (NAME) ); 
...
create table S15827_LOGIC_GATE (
	NAME VARCHAR(30) not null,
	LOGIC_TYPE VARCHAR(4) null,
	GPIO tinyint null,
	LOGIC_FAMILY VARCHAR(4) null, constraint LOGIC_GATE_PK primary key (NAME) ); 
--============================================================================================================
--============================================================================================================
--  ____      _       _   _                 
